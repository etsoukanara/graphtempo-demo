		...
		with st.container():
			...
			if submitted_expl_sky and result_sky:
				...
				with st.expander("3-D visualization"):
					st.write('Blue bars depict the top 3 results. The x-axis represents past intervals, the y-axis shows reference points, and the z-axis depicts the count of edges at each point, as indicated at the top of each bar.')
