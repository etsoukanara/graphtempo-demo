		...
		with st.container():
			...
			if submitted_expl_sky and result_sky:
				...
				with st.expander("3-D visualization"):
					st.write('The x-axis represents past intervals, the y-axis shows reference points, and the z-axis depicts the count of edges at each point, as indicated at the top of each bar. Blue bars depict the top 3 results.')
				...
				with st.expander("2-D visualization"):
					st.write('Separate plot for each reference point. The x-axis represents past intervals, and the y-axis shows the count of edges. Different results are shown with distinct line colors. Hover over a line to view the edge count, reference point, and the start and end times of the interval.')
					###
