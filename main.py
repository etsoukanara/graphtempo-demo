...
if app_mode == "Show instructions":
    ...
    with st.container():
    	...
    	st.write('We provide three real-world datasets for testing the tasks of aggregation and exploration. Alternatively, the user can upload his/her own dataset providing it follows the appropriate format. Main functions are:')
